...
export const UpComing = () => {
    ...
    return (
        <div className="launchesList">
            <h3>Up-Coming Space X Launches</h3>
                                ...
                                <CardContent className="slCard">
                                    ...
                                    <div className="imageDiv">
                                        {(launch.links?.mission_patch_small)?.length && launch.links?.mission_patch_small ?
                                            <img src={launch.links?.mission_patch_small} className="cardImage" alt="upComing" />
                                            : <img src={noImage} className="cardImage" alt="upComing" />}
                                    </div>
                                    ...
                                    <Link to={`/launches/upcoming/${launch?.flight_number}`} className=" buttonLink">
                                        <Button
                                            variant="contained"
